...
import com.yuan.yuanaicodeproducer.ai.model.message.*;
import com.yuan.yuanaicodeproducer.ai.tools.BaseTool;
import com.yuan.yuanaicodeproducer.ai.tools.ToolManager;
 ...
 * @author LXY
 * @version 1.0
 * @date 2025-08-29 16:05:16
 * @className JsonMessageStreamHandler
 * @description Json流消息处理器
 * 处理 VUE PROJECT 类型的复杂流式响应，包含工具调用信息
 */
@Slf4j
@Component
...
public class JsonMessageStreamHandler {
    ...
    private String handleJsonMessageChunk(String chunk, StringBuilder chatHistoryStringBuilder, Set<String> seenToolIds) {
        // 解析 JSON ，先还原成基类StreamMessage，再根据类型转换成具体消息类型（子类）
