package com.yuan.yuanaicodeproducer.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.yuan.yuanaicodeproducer.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://alexavieryuan.us.kg/\">元仔学习</a>")
                .setSince("2025");
        return globalConfig;
    }
}
